...
naming inconsistencies are corrected, and a unified table of
sample-level information is produced.

## Usage

``` r
data_eDNA(token = NULL)
```
...
- token:
  ...
  A personal access token to allow downloading from Github generated by
  going here: https://github.com/settings/tokens and clicking 'Generate
  New Token'
